    ...
    public class DataServer
    {
        ...
        public static List<DialogTreeJson> GetTreeDataSource(DialogItem dlg, Dictionary<string, string> paras)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //查找子元素
                return ParentIds.Distinct().SelectMany(i => GetChildrens(tt, dt, i)).Distinct().ToList();
            }
            else
            {
        ...
        static List<DialogTreeJson> GetChildrens(DialogTree dd, DataTable dt, object pid)
        {
